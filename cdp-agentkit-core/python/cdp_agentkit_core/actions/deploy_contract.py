...
This tool will deploy an arbitrary contract. It takes a map of arbitrary customer arguments as input.
The token will be deployed using the wallet's default address.
"""
