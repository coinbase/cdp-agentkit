...
export const WOW_FACTORY_CONTRACT_ADDRESSES = {
...
export function getFactoryAddress(network: string): string {
  ...
  return WOW_FACTORY_CONTRACT_ADDRESSES[normalizedNetwork as keyof typeof WOW_FACTORY_CONTRACT_ADDRESSES];
}
